...
#Variables permettant de récupérer le nom de domaine
...
#Récupération de la variable contenant le chemin et nom du fichier sélectionner
$OpenFileDialog.FileName = $csvFile
