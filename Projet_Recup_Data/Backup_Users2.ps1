...
$Destination = Write-Host "Veuillez renseigner le serveur ou emplacement de sauvegarde du profil \\SERVER\Share\backups"
$$Full_username=Read-Host "Veuillez entrer le nom d'utilisateur explicite (sans espace) : "
$DestinationFolderUser= ("$Destination" + "\" + "$Full_username" + "\" + "\")
...
{ 
	...
	$caption = "Choisissez une actipon";
